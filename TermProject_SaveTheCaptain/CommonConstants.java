...
public class CommonConstants {
    ...
    public static final String FONT_PATH = "resources/Roboto-Condensed.ttf";
    ...
    // size config
    public static final Dimension FRAME_SIZE = new Dimension(700, 1046);
    public static final Dimension BUTTON_PANEL_SIZE = new Dimension(FRAME_SIZE.width, (int)(FRAME_SIZE.height * 0.3));
